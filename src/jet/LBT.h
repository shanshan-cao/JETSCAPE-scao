...
class LBT : public JetEnergyLossModule<LBT> //, public std::enable_shared_from_this<Matter>
{  
 public:
...
///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  const int outFormat=2;    // different output formats: 1 - my preferred, 2 - for JETSCAPE patch code
  ...
  //...switches and cuts
  int       Kprimary=0;  // 0 keep all partons, 1 keep leading jet parton only (switch off other partons)
  ...
  double Ecmcut=0.5;                   //energy cut for free streaming   
